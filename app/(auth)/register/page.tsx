...
export default function RegisterPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 md:p-8 bg-gradient-to-br from-[#fdfbf7] via-[#fff5f6] to-[#fff0e6] relative overflow-hidden font-sans selection:bg-[#ff758c] selection:text-white select-none">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[350px] h-[350px] bg-pink-300/30 rounded-full blur-3xl pointer-events-none animate-pulse" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[400px] h-[400px] bg-orange-300/25 rounded-full blur-3xl pointer-events-none animate-pulse" />
      <div className="absolute bottom-[30%] right-[15%] w-[250px] h-[250px] bg-rose-200/20 rounded-full blur-2xl pointer-events-none" />

      {/* Main Glassmorphism Card */}
      <div className="w-full max-w-[460px] bg-white/80 backdrop-blur-2xl rounded-[3rem] p-8 md:p-10 shadow-2xl border-2 border-orange-100/80 relative z-10 flex flex-col items-center mt-8 pt-14">
        ...
        <div className="text-center mb-6 w-full">
          ...
          <div className="mt-3 bg-orange-50/80 border border-orange-200/80 rounded-2xl p-3 text-xs md:text-sm text-[#5c4d47] font-medium shadow-inner relative">
            <span className="text-[#ff758c] font-bold">Livia:</span> &ldquo;Hai calon penghuni baru! Yuk daftar biar kita bisa jadi teman kos yang seru~ ✨&rdquo;
