...
const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    content: [
      { speaker: "Narator", text: "Pagi itu, sinar mentari menembus jendela kamarmu. Aroma kopi yang harum menggelitik hidungmu, membangunkanmu dari tidur lelap.", expression: "normal" },
      { speaker: "Narator", text: "Kamu berjalan keluar kamar dan terkejut melihat pemandangan di dapurmu.", expression: "normal" },
      { speaker: "Livia", text: "Eh, udah bangun? Tuh kopinya diminum mumpung masih hangat.", expression: "normal" },
      { speaker: "Narator", text: "Kamu menatap heran. Livia yang biasanya selalu bangun siang, kini sudah rapi dengan celemek kesayangannya... di dalam dapurmu.", expression: "normal" },
      ...
      { speaker: "Livia", text: "K-kemarin malam kamu lupa kunci pintu, tau! Terus pintunya sedikit kebuka, yaudah aku masuk aja!", expression: "blushing", nextIndex: 8 },
      { speaker: "Livia", text: "K-kepedean! Aku cuma kebetulan lewat dan lihat pintumu nggak kekunci! Siapa juga yang mau nungguin kamu bangun?!", expression: "angry", nextIndex: 8 },
      { speaker: "Livia", text: "E-enak aja! Aku masuk karena pintu depanmu nggak kekunci dari semalam! Makanya hati-hati dong!", expression: "angry", nextIndex: 8 },
      { speaker: "Narator", text: "Kamu duduk di meja makan, lalu mencoba menyesap kopi buatan Livia.", expression: "normal" },
      { speaker: "Livia", text: "Gimana... rasanya? Terlalu manis nggak? Atau kurang pahit?", expression: "blushing" },
      { speaker: "Narator", text: "Rasa kopinya luar biasa pas. Busa susunya juga lembut, seperti buatan barista kafe.", expression: "normal" },
      { speaker: "Livia", text: "S-syukurlah kalau kamu suka... Aku semalaman nonton puluhan video tutorial cara bikin kopi ala kafe tau.", expression: "happy" },
      { speaker: "Livia", text: "Eh! B-bukan berarti aku sengaja begadang belajar buat kamu ya! Aku cuma... penasaran aja!", expression: "angry" },
      { speaker: "Narator", text: "Kamu tertawa kecil. Selain kopi, kamu melihat ada piring berisi roti bakar di atas meja.", expression: "normal" },
      { speaker: "Livia", text: "I-itu... aku juga nyoba bikin sarapan. Roti bakar lapis selai.", expression: "serious" },
      { speaker: "Livia", text: "Tapi... bagian bawahnya agak gosong sedikit. Tadi aku kelupaan ngecilin api kompor.", expression: "pain",
        choices: [
      ...
      { speaker: "Livia", text: "Beneran? Jangan dipaksa ya kalau nggak enak.", expression: "normal", nextIndex: 19 },
      { speaker: "Livia", text: "Alesan macam apa itu?! Tapi... syukurlah kalau kamu mau makan.", expression: "pleased", nextIndex: 19 },
      { speaker: "Livia", text: "J-jangan sok pahlawan! Kita bagi dua aja gosongnya!", expression: "blushing", nextIndex: 19 },
      { speaker: "Narator", text: "Kalian pun menikmati sarapan sederhana itu bersama. Meski sedikit gosong, roti itu terasa sangat nikmat.", expression: "normal" },
      { speaker: "Narator", text: "Selesai makan, Livia menatapmu lamat-lamat.", expression: "normal" },
      { speaker: "Livia", text: "Ngomong-ngomong... aku perhatiin belakangan ini kamu kerja terlalu keras. Kantung matamu udah kayak panda.", expression: "clingy" },
      { speaker: "Livia", text: "Tugasmu banyak banget ya? Sampai sering begadang gitu?", expression: "serious",
        choices: [
      ...
      { speaker: "Livia", text: "Ukh... pantesan kamu kelihatan capek banget.", expression: "pain", nextIndex: 26 },
      { speaker: "Livia", text: "Huuu... dasar pekerja keras. Kalau sakit kan repot.", expression: "serious", nextIndex: 26 },
      { speaker: "Livia", text: "M-masa depan?! S-siapa yang mau punya masa depan sama kamu?!", expression: "blushing", nextIndex: 26 },
      { speaker: "Narator", text: "Livia tiba-tiba berdiri dari kursinya dan berjalan ke belakang kursimu.", expression: "normal" },
      { speaker: "Livia", text: "Diam sebentar. Jangan gerak-gerak.", expression: "serious" },
      { speaker: "Narator", text: "Kamu merasakan kedua tangannya yang kecil menempel di pundakmu.", expression: "normal" },
      { speaker: "Livia", text: "Biar aku pijitin pundakmu sedikit. Sebagai balasan karena kamu sering bantuin aku.", expression: "blushing" },
      { speaker: "Narator", text: "Pijatan Livia terasa kikuk. Kadang terlalu pelan, kadang sedikit keras, tapi ketulusannya begitu terasa.", expression: "normal" },
      { speaker: "Livia", text: "Aku... aku tahu aku sering merepotkanmu. Aku malas, manja, suka ngambek...", expression: "normal" },
      { speaker: "Livia", text: "Tapi... melihatmu berusaha sekeras ini, aku jadi ngerasa nggak berguna kalau cuma diam aja.", expression: "pain" },
      { speaker: "Livia", text: "Makanya, aku mau belajar pelan-pelan. Mulai dari bikin kopi, bikin sarapan...", expression: "serious" },
      { speaker: "Livia", text: "Supaya... supaya aku juga bisa jadi seseorang yang bisa kamu andalkan.", expression: "happy",
        choices: [
      ...
      { speaker: "Livia", text: "B-beneran? Aku harap kamu nggak bohong cuma buat nyenengin aku.", expression: "blushing", nextIndex: 38 },
      { speaker: "Livia", text: "A-aku kan lagi serius tau! Ngerusak suasana aja sih!", expression: "angry", nextIndex: 38 },
      { speaker: "Livia", text: "Enak aja ngelunjak! Pelan-pelan dong, aku kan baru level pemula!", expression: "angry", nextIndex: 38 },
      { speaker: "Narator", text: "Pijatannya perlahan berhenti. Livia mencondongkan tubuhnya ke depan.", expression: "normal" },
      { speaker: "Livia", text: "Jadi... jangan paksakan dirimu ya. Kalau capek, istirahatlah.", expression: "clingy" },
      { speaker: "Livia", text: "Pintu kamarku... selalu terbuka kalau kamu butuh teman ngobrol, atau... pelukan?", expression: "blushing" },
      { speaker: "Narator", text: "Sebelum kamu sempat menjawab, Livia sudah berlari kecil menjauh dengan wajah merah padam.", expression: "normal" },
      { speaker: "Livia", text: "A-aku mau cuci piring dulu! Sana lanjut kerja gih!", expression: "angry" },
      { speaker: "Narator", text: "Kamu tersenyum sambil kembali menatap layar laptop. Rasa lelahmu benar-benar menguap hari ini.", expression: "normal" }
    ]
  },
  {
    id: 7,
    ...
    content: [
      { speaker: "Narator", text: "Akhir pekan tiba. Hujan turun rintik-rintik sejak pagi, menciptakan hawa dingin yang menusuk tulang.", expression: "normal" },
      { speaker: "Narator", text: "Di ruang tengah, kamu mendapati Livia sedang menggulung dirinya di dalam selimut tebal, terlihat seperti kepompong besar di atas karpet.", expression: "normal" },
      { speaker: "Livia", text: "Haaah... cuaca begini emang paling enak buat tiduran aja seharian. Nggak ngapa-ngapain.", expression: "happy" },
      { speaker: "Livia", text: "Hei, kamu ngapain masih duduk di meja kerja? Sini dong, temenin aku rebahan.", expression: "clingy" },
      { speaker: "Livia", text: "Nggak usah mikirin tugas dan kerjaan terus untuk hari ini. Otakmu butuh liburan tau.", expression: "normal",
        choices: [
      ...
      { speaker: "Livia", text: "Mana ada lima menit! Minimal lima jam!", expression: "angry", nextIndex: 8 },
      { speaker: "Livia", text: "Biarin! Biar kita jadi duo pemalas sejati!", expression: "happy", nextIndex: 8 },
      { speaker: "Livia", text: "Makanya buruan sini, selimutnya masih muat kok buat berdua.", expression: "pleased", nextIndex: 8 },
      { speaker: "Narator", text: "Kamu akhirnya mengalah. Meninggalkan mejamu, kamu ikut berbaring di sebelah Livia.", expression: "normal" },
      { speaker: "Narator", text: "Livia dengan cepat menarik ujung selimutnya dan menutupi tubuhmu juga. Kehangatan langsung menjalar.", expression: "normal" },
      { speaker: "Livia", text: "Hehe... nyaman banget kan? Sesekali jadi kaum rebahan itu nggak ada salahnya.", expression: "happy" },
      { speaker: "Livia", text: "Ngomong-ngomong, karena kita lagi santai... mau order makanan ringan nggak? Aku pengen ngunyah sesuatu.", expression: "normal",
        choices: [
      ...
      { speaker: "Livia", text: "Wah, setuju! Tambah keju mozarella ya!", expression: "happy", nextIndex: 15 },
      { speaker: "Livia", text: "Boleh juga, yang topping coklat kacang!", expression: "pleased", nextIndex: 15 },
      { speaker: "Livia", text: "Klasik banget, tapi boleh deh pakai telur setengah matang!", expression: "happy", nextIndex: 15 },
      { speaker: "Narator", text: "Sambil menunggu pesanan datang, kalian memutuskan untuk menonton film dari laptop.", expression: "normal" },
      { speaker: "Livia", text: "Pilih genre filmnya dong. Karena cuacanya lagi mendung, mending horor nggak sih?", expression: "flirty",
        choices: [
      ...
      { speaker: "Livia", text: "B-berani lah! Palingan setan bohongan!", expression: "angry", nextIndex: 20 },
      { speaker: "Livia", text: "Huuu penakut. Ya udah deh, biar kamu nggak ketakutan.", expression: "pleased", nextIndex: 20 },
      { speaker: "Livia", text: "R-romantis?! S-siapa juga yang mau romantis-romantisan sama kamu!", expression: "blushing", nextIndex: 20 },
      { speaker: "Narator", text: "Tak lama kemudian makanan datang. Kalian menikmati cemilan hangat sambil menonton film pilihan.", expression: "normal" },
      { speaker: "Narator", text: "Di luar sana, hujan semakin deras. Angin kencang sesekali menghantam jendela kaca.", expression: "normal" },
      { speaker: "Livia", text: "Ukh... hujannya makin parah ya. Bikin merinding aja.", expression: "serious" },
      { speaker: "Narator", text: "TIBA-TIBA...", expression: "normal" },
      { speaker: "Narator", text: "*CTAR! JGEEERRR!!*", expression: "normal" },
      { speaker: "Livia", text: "KYAAAAA!!!", expression: "scared" },
      { speaker: "Narator", text: "Seiring dengan gelegar guntur yang memekakkan telinga, lampu apartemen seketika padam. Kegelapan menyelimuti ruangan.", expression: "normal" },
      { speaker: "Livia", text: "H-hei... k-kamu di mana?! Gelap banget! Aku nggak bisa lihat apa-apa!", expression: "pain" },
      { speaker: "Narator", text: "Dalam kepanikan, Livia meraba-raba dan langsung memeluk erat tubuhmu. Ia gemetar.", expression: "normal" },
      { speaker: "Livia", text: "J-jangan tinggalin aku... a-aku paling takut sama gelap dan petir...", expression: "clingy",
        choices: [
      ...
      { speaker: "Livia", text: "B-beneran ya? Jangan pergi kemana-mana lho!", expression: "pain", nextIndex: 33 },
      { speaker: "Livia", text: "Iya... ukh, tanganku dingin banget kan...", expression: "pain", nextIndex: 33 },
      { speaker: "Livia", text: "A-apa yang kamu lakuin?! T-tapi... rasanya aman. Teruslah begini...", expression: "blushing", nextIndex: 33 },
      { speaker: "Narator", text: "Kamu menyalakan senter dari ponselmu dan mengarahkannya ke langit-langit, memberikan penerangan remang.", expression: "normal" },
      { speaker: "Narator", text: "Wajah Livia terlihat pucat, namun genggamannya pada bajumu perlahan mengendur seiring hadirnya cahaya.", expression: "normal" },
      { speaker: "Livia", text: "Fuh... syukurlah ada cahaya. M-maaf ya, aku cengeng banget.", expression: "sad" },
      { speaker: "Livia", text: "Dari kecil, tiap kali mati lampu karena petir, aku selalu sembunyi di dalam lemari sendirian.", expression: "serious" },
      { speaker: "Livia", text: "Orang tuaku sering lembur kerja, jadi... aku terbiasa menghadapi ketakutanku sendirian.", expression: "normal" },
      { speaker: "Livia", text: "Tapi hari ini... karena ada kamu, rasanya nggak seseram dulu lagi.", expression: "happy",
        choices: [
      ...
      { speaker: "Livia", text: "Kamu ini... selalu tau cara bikin orang tersentuh ya.", expression: "blushing", nextIndex: 42 },
      { speaker: "Livia", text: "J-janji lho ya! Kalau bohong, aku kutuk jadi kecoak!", expression: "angry", nextIndex: 42 },
      { speaker: "Livia", text: "Biarin! Sengaja kok biar bisa modus meluk-meluk!", expression: "silly", nextIndex: 42 },
      { speaker: "Narator", text: "Sekitar dua puluh menit berlalu. Tiba-tiba lampu kembali menyala terang.", expression: "normal" },
      { speaker: "Livia", text: "Ah! Nyala lagi!", expression: "happy" },
      { speaker: "Narator", text: "Livia segera tersadar betapa eratnya ia memelukmu. Ia langsung melompat mundur dengan wajah bersemu merah.", expression: "normal" },
      { speaker: "Livia", text: "E-ekhem! L-lupakan kejadian barusan! Anggap aja aku lagi kesurupan!", expression: "blushing" },
      { speaker: "Livia", text: "Ayo lanjut nontonnya! Filmnya masih seru tau!", expression: "angry" },
      { speaker: "Narator", text: "Kamu hanya bisa tertawa melihat tingkah tsundere-nya yang kembali kumat. Hujan di luar sana masih turun, namun harimu terasa begitu hangat.", expression: "normal" }
    ]
  },
  {
    id: 8,
