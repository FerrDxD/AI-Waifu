...
const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    content: [
      { speaker: "Narator", text: "Pagi itu, sinar mentari menembus jendela kamarmu. Aroma kopi yang harum menggelitik hidungmu, membangunkanmu dari tidur lelap.", expression: "normal","bg":"6.1" },
      { speaker: "Narator", text: "Kamu berjalan keluar kamar dan terkejut melihat pemandangan di dapurmu.", expression: "normal","bg":"6.2" },
      { speaker: "Livia", text: "Eh, udah bangun? Tuh kopinya diminum mumpung masih hangat.", expression: "normal","bg":"6.2"},
      { speaker: "Narator", text: "Kamu menatap heran. Livia yang biasanya selalu bangun siang, kini sudah rapi dengan celemek kesayangannya... di dalam dapurmu.", expression: "normal","bg":"6.2"},
      { speaker: "Livia", text: "Apa liat-liat?! Nggak usah mikir macem-macem. Aku cuma kebetulan bangun kepagian dan sekalian aja bikin kopi!", expression: "angry","bg":"6.2",
        choices: [
      ...
      { speaker: "Livia", text: "K-kemarin malam kamu lupa kunci pintu, tau! Terus pintunya sedikit kebuka, yaudah aku masuk aja!", expression: "blushing","bg":"6.2", nextIndex: 8 },
      { speaker: "Livia", text: "K-kepedean! Aku cuma kebetulan lewat dan lihat pintumu nggak kekunci! Siapa juga yang mau nungguin kamu bangun?!", expression: "angry","bg":"6.2", nextIndex: 8 },
      { speaker: "Livia", text: "E-enak aja! Aku masuk karena pintu depanmu nggak kekunci dari semalam! Makanya hati-hati dong!", expression: "angry","bg":"6.2", nextIndex: 8 },
      { speaker: "Narator", text: "Kamu duduk di meja makan, lalu mencoba menyesap kopi buatan Livia.", expression: "normal","bg":"6.2" },
      { speaker: "Livia", text: "Gimana... rasanya? Terlalu manis nggak? Atau kurang pahit?", expression: "blushing","bg":"6.2" },
      { speaker: "Narator", text: "Rasa kopinya luar biasa pas. Busa susunya juga lembut, seperti buatan barista kafe.", expression: "normal","bg":"6.2" },
      { speaker: "Livia", text: "S-syukurlah kalau kamu suka... Aku semalaman nonton puluhan video tutorial cara bikin kopi ala kafe tau.", expression: "happy","bg":"6.2" },
      { speaker: "Livia", text: "Eh! B-bukan berarti aku sengaja begadang belajar buat kamu ya! Aku cuma... penasaran aja!", expression: "angry","bg":"6.2" },
      { speaker: "Narator", text: "Kamu tertawa kecil. Selain kopi, kamu melihat ada piring berisi roti bakar di atas meja.", expression: "normal","bg":"6.2" },
      { speaker: "Livia", text: "I-itu... aku juga nyoba bikin sarapan. Roti bakar lapis selai.", expression: "serious","bg":"6.2" },
      { speaker: "Livia", text: "Tapi... bagian bawahnya agak gosong sedikit. Tadi aku kelupaan ngecilin api kompor.", expression: "pain","bg":"6.2",
        choices: [
      ...
      { speaker: "Livia", text: "Beneran? Jangan dipaksa ya kalau nggak enak.", expression: "normal","bg":"6.2", nextIndex: 19 },
      { speaker: "Livia", text: "Alesan macam apa itu?! Tapi... syukurlah kalau kamu mau makan.", expression: "pleased","bg":"6.2", nextIndex: 19 },
      { speaker: "Livia", text: "J-jangan sok pahlawan! Kita bagi dua aja gosongnya!", expression: "blushing","bg":"6.2", nextIndex: 19 },
      { speaker: "Narator", text: "Kalian pun menikmati sarapan sederhana itu bersama. Meski sedikit gosong, roti itu terasa sangat nikmat.", expression: "normal","bg":"6.2" },
      { speaker: "Narator", text: "Selesai makan, Livia menatapmu lamat-lamat.", expression: "normal","bg":"6.2" },
      { speaker: "Livia", text: "Ngomong-ngomong... aku perhatiin belakangan ini kamu kerja terlalu keras. Kantung matamu udah kayak panda.", expression: "clingy","bg":"6.2" },
      { speaker: "Livia", text: "Tugasmu banyak banget ya? Sampai sering begadang gitu?", expression: "serious","bg":"6.2",
        choices: [
      ...
      { speaker: "Livia", text: "Ukh... pantesan kamu kelihatan capek banget.", expression: "pain","bg":"6.2", nextIndex: 26 },
      { speaker: "Livia", text: "Huuu... dasar pekerja keras. Kalau sakit kan repot.", expression: "serious","bg":"6.2", nextIndex: 26 },
      { speaker: "Livia", text: "M-masa depan?! S-siapa yang mau punya masa depan sama kamu?!", expression: "blushing","bg":"6.2", nextIndex: 26 },
      { speaker: "Narator", text: "Livia tiba-tiba berdiri dari kursinya dan berjalan ke belakang kursimu.", expression: "normal","bg":"6.2" },
      { speaker: "Livia", text: "Diam sebentar. Jangan gerak-gerak.", expression: "serious","bg":"6.2" },
      { speaker: "Narator", text: "Kamu merasakan kedua tangannya yang kecil menempel di pundakmu.", expression: "normal","bg":"6.2" },
      { speaker: "Livia", text: "Biar aku pijitin pundakmu sedikit. Sebagai balasan karena kamu sering bantuin aku.", expression: "blushing","bg":"6.2" },
      { speaker: "Narator", text: "Pijatan Livia terasa kikuk. Kadang terlalu pelan, kadang sedikit keras, tapi ketulusannya begitu terasa.", expression: "normal","bg":"6.2" },
      { speaker: "Livia", text: "Aku... aku tahu aku sering merepotkanmu. Aku malas, manja, suka ngambek...", expression: "normal","bg":"6.2" },
      { speaker: "Livia", text: "Tapi... melihatmu berusaha sekeras ini, aku jadi ngerasa nggak berguna kalau cuma diam aja.", expression: "pain","bg":"6.2" },
      { speaker: "Livia", text: "Makanya, aku mau belajar pelan-pelan. Mulai dari bikin kopi, bikin sarapan...", expression: "serious","bg":"6.2" },
      { speaker: "Livia", text: "Supaya... supaya aku juga bisa jadi seseorang yang bisa kamu andalkan.", expression: "happy","bg":"6.2",
        choices: [
      ...
      { speaker: "Livia", text: "B-beneran? Aku harap kamu nggak bohong cuma buat nyenengin aku.", expression: "blushing","bg":"6.2", nextIndex: 38 },
      { speaker: "Livia", text: "A-aku kan lagi serius tau! Ngerusak suasana aja sih!", expression: "angry","bg":"6.2", nextIndex: 38 },
      { speaker: "Livia", text: "Enak aja ngelunjak! Pelan-pelan dong, aku kan baru level pemula!", expression: "angry","bg":"6.2", nextIndex: 38 },
      { speaker: "Narator", text: "Pijatannya perlahan berhenti. Livia mencondongkan tubuhnya ke depan.", expression: "normal","bg":"6.2" },
      { speaker: "Livia", text: "Jadi... jangan paksakan dirimu ya. Kalau capek, istirahatlah.", expression: "clingy","bg":"6.2" },
      { speaker: "Livia", text: "Pintu kamarku... selalu terbuka kalau kamu butuh teman ngobrol, atau... pelukan?", expression: "blushing","bg":"6.2" },
      { speaker: "Narator", text: "Sebelum kamu sempat menjawab, Livia sudah berlari kecil menjauh dengan wajah merah padam.", expression: "normal","bg":"6.2" },
      { speaker: "Livia", text: "A-aku mau cuci piring dulu! Sana lanjut kerja gih!", expression: "angry","bg":"6.2" },
      { speaker: "Narator", text: "Kamu tersenyum sambil kembali menatap layar laptop. Rasa lelahmu benar-benar menguap hari ini.", expression: "normal","bg":"6.2" }
    ]
  },
  {
    id: 7,
