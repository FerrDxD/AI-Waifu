...
const SCENES: Scene[] = [
  ...
  { speaker: "Narator", text: "Beberapa hari sebelum semester baru dimulai. Kamu sedang bersantai di kamar kos yang masih sepi.", expression: "normal", bg: "/bg_story-0.webp", hideSprite: true },
  { speaker: "Narator", text: "Tiba-tiba ponselmu bergetar — panggilan video dari nomor yang tidak kamu kenal.", expression: "normal", bg: "/bg_story-0.webp", hideSprite: true },

  // Scene 2-3: Laura muncul di layar (kita lihat latar belakang rumahnya)
  { speaker: "Narator", text: "Kamu mengangkat panggilan itu. Muncul wajah seorang wanita paruh baya yang terlihat ramah di layar ponselmu.", expression: "normal", bg: "/bg_story-8.9.webp", hideSprite: true },
  { speaker: "Laura", text: "Halo! Maaf ya tiba-tiba menghubungi. Ini benar nomornya yang dikasih Mas Dito dari kampus?", expression: "happy", bg: "/bg_story-8.9.webp" },

  // Scene 4-7: Laura memperkenalkan diri dan situasi
  { speaker: "Laura", text: "Syukurlah! Tante Laura — ibunya Livia. Mas Dito bilang kamu teman kampus yang bisa diandalkan, dan kebetulan juga tinggal di kos Jalan Melati.", expression: "pleased", bg: "/bg_story-8.9.webp" },
  { speaker: "Laura", text: "Begini. Putri Tante — Livia — minggu depan mulai kuliah di kotamu. Tante udah sewa kosan buat dia, dan ternyata... satu gedung sama kamu!", expression: "serious", bg: "/bg_story-8.9.webp" },
  { speaker: "Laura", text: "Tante khawatir banget ngelepas anak gadis sendirian ke kota besar. Livia itu agak keras kepala dan gampang panik... tapi sebenarnya hatinya baik.", expression: "normal", bg: "/bg_story-8.9.webp" },

  // Scene 7: Choice — MC merespons
  { speaker: "Laura", text: "Boleh nggak Tante minta tolong? Bantuin Livia pindahan ke kosan, sekalian titip dia ya. Awasi dari jauh aja, nggak perlu lebay.", expression: "happy", bg: "/bg_story-8.9.webp",
    choices: [
  ...
  { speaker: "Laura", text: "Alhamdulillah! Tante lega banget. Kamu memang bisa diandalkan.", expression: "happy", bg: "/bg_story-8.9.webp", nextIndex: 11 },
  { speaker: "Laura", text: "Ah, Livia itu... keras kepala, gampang panik, sedikit drama. Tapi nanti kamu bakal paham sendiri.", expression: "flirty", bg: "/bg_story-8.9.webp", nextIndex: 11 },
  { speaker: "Laura", text: "Hahaha, Tante sendiri juga heran! Tapi memang begini rezeki ya, tidak terduga.", expression: "silly", bg: "/bg_story-8.9.webp", nextIndex: 11 },

  // Scene 11-12: Laura mau panggilin Livia ke depan kamera
  { speaker: "Laura", text: "Ngomong-ngomong, Livia sedang packing di kamarnya sekarang. Biar Tante panggilin, supaya kalian bisa kenalan dulu lewat video sebelum ketemu langsung nanti.", expression: "pleased", bg: "/bg_story-8.9.webp" },
  { speaker: "Laura", text: "Livia sayang! Sini sebentar ke sini, ada yang Ibu kenalin!", expression: "happy", bg: "/bg_story-8.9.webp" },

  // Scene 13-14: Narasi Livia mendekat ke kamera
  { speaker: "Narator", text: "Terdengar suara langkah kaki. Sebentar kemudian, wajah seorang gadis muncul ke depan layar dengan dahi berkerut.", expression: "normal", bg: "/bg_story-8.9.webp", hideSprite: true },

  // Scene 15-17: Livia muncul, bingung lihat MC di layar
  { speaker: "Livia", text: "Ibu, aku lagi sibuk—", expression: "angry", bg: "/bg_story-8.9.webp" },
  { speaker: "Livia", text: "...eh? Ini siapa?", expression: "confused", bg: "/bg_story-8.9.webp" },
  { speaker: "Laura", text: "Ini yang Ibu ceritain! Dia kuliah di kotamu, kosannya satu gedung sama kosanmu nanti. Dia yang bakal bantuin kamu pindahan.", expression: "pleased", bg: "/bg_story-8.9.webp" },

  // Scene 18-20: Livia bereaksi
  { speaker: "Livia", text: "Ha?! Ibu nggak bilang-bilang kalau mau minta orang lain buat nemenin aku!", expression: "scared", bg: "/bg_story-8.9.webp" },
  { speaker: "Laura", text: "Makanya kenalan dulu sekarang! Salam dong sama orangnya!", expression: "serious", bg: "/bg_story-8.9.webp" },
  { speaker: "Livia", text: "Huft... y-yaudah. Maaf ya tadi Ibu nggak bilang apa-apa dulu.", expression: "serious", bg: "/bg_story-8.9.webp" },

  // Scene 21: Choice Livia
  { speaker: "Livia", text: "...salam kenal. Aku Livia. Kosan kita memang satu gedung beneran?", expression: "normal", bg: "/bg_story-8.9.webp",
    choices: [
  ...
  { speaker: "Livia", text: "...oh. Lumayan sih ada yang udah kenal di sana.", expression: "normal", bg: "/bg_story-8.9.webp", nextIndex: 25 },
  { speaker: "Livia", text: "...iya, sama-sama baru tau. Huh, Ibu ini.", expression: "blushing", bg: "/bg_story-8.9.webp", nextIndex: 25 },
  { speaker: "Livia", text: "E-ekspresif?! Kamu baru kenal dan sudah macam-macam ya!", expression: "angry", bg: "/bg_story-8.9.webp", nextIndex: 25 },

  // Scene 25: Laura menutup video call
  { speaker: "Laura", text: "Oke, makasih banyak ya sudah mau bantu! Tante tutup dulu videonya. Sampai ketemu nanti hari pindahan!", expression: "happy", bg: "/bg_story-8.9.webp" },

  // Scene 26-27: Kembali ke perspektif MC di kos
  { speaker: "Narator", text: "Layar ponselmu kembali gelap. Kamu meletakkannya pelan dan menatap langit-langit kamar.", expression: "normal", bg: "/bg_story-0.webp", hideSprite: true },
  { speaker: "Narator", text: "Tetangga baru yang terdengar keras kepala... tapi entah kenapa perkenalan yang tidak terduga itu terasa menarik.", expression: "normal", bg: "/bg_story-0.webp", hideSprite: true },

  // Scene 28: Time skip ke hari pindahan
  { speaker: "Narator", text: "Beberapa hari kemudian — hari pindahan tiba.", expression: "normal", bg: "/bg_story-0.webp", hideSprite: true },

  // Scene 29-32: Di depan kosan, Livia datang dengan koper dan kardus
  { speaker: "Livia", text: "Koperku udah nggak muat, tapi masih banyak barang yang kayaknya wajib dibawa ke kota.", expression: "confused", bg: "/bg_story-8.12.webp" },
  { speaker: "Livia", text: "Y-yaudah, kamu bantu pilih ya. Tapi jangan masukin barang yang nggak penting!", expression: "clingy", bg: "/bg_story-8.12.webp" },
  { speaker: "Narator", text: "Kamu mengangguk. Hari pertama bersama tetangga barumu ini terasa lebih hidup dari yang kamu bayangkan.", expression: "normal", bg: "/bg_story-8.12.webp", hideSprite: true },
];
...
export default function VNScene({ onComplete }: VNSceneProps) {
  ...
  return (
    <div className="relative w-full h-screen flex flex-col items-center overflow-hidden bg-pink-50 select-none">
      ...
      <img 
        src={scene.bg || "/bg_story-8.9.webp"}
        alt="Room Background"
        className={cn(
